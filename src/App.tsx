      ...
      <Container>
        ...
        <Row>
          <Col md={6} className="mt-5">
            <ContentBlock
              title="デジクリとは"
              text={`デジクリは、芝浦工業大学に所属するデジタルクリエーションサークルです。ゲーム制作をはじめ、アプリケーション開発などのプログラミング、イラスト制作、3Dモデリング、音楽制作、動画制作、VTuber活動など、さまざまなデジタルコンテンツの創作活動を行なっています。
