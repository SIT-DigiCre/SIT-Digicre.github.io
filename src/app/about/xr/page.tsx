              ...
              <div className="mx-auto max-w-4xl">
                <div className="p-8">
                  <p>
                    ...
                    エックスアールという読み方のほかに、クロス・リアリティ（Cross
                    Reality）やエクステンデッド・リアリティ（Extended
                    Reality）というものもあります。
                    表記もXRだったり、xR（xが小文字）だったりします。
                    <br />
                    <br />
                    VR（Virtual
                    Reality）とは、仮想現実とも呼ばれ、その名の通り仮想空間を表示させ体験できる技術です。
                    「Oculus Quest
                    2」のようなHMD（ヘッドマウントディスプレイ）を装着することで、バーチャル空間に没入することができます。
                    <br />
                    AR（Augmented
                    Reality）とは、拡張現実とも呼ばれ、現実世界に対して情報を加えて表示する技術です。「Pokémon
                    GO」に活用されていることで有名ですね。
                    ニンテンドー3DSに内蔵されていた「ARゲームズ」という、カメラで写したカードからキャラクターが飛び出して見えるミニゲームで遊んだ方も多いのではないでしょうか。
                    <br />
                    この2つを合わせた中間のものがMR（Mixed
                    Reality）で、複合現実ともいいます。現実世界と仮想空間が相互に影響しあうのが特徴です。
                    <br />
                    これらの境界線はかなり曖昧なので、大雑把に理解すれば大丈夫です。
                    <br />
                    <br />
                    xR技術はプログラミングや3DCGなどの複合技術であるため、様々な班が関わっており、xR班のみに在籍しているメンバーはおりません。
                    なので、xR班が単独で活動することはなく、様々な班のメンバーが集まり制作する企画として存在しています。
                    <br />
                    具体的には、VR機器に対応したスタイリッシュ海戦シューティングゲームを開発する「Fleet
                    VR企画」や、
                    サークル独自のVtuberを運営する「デジコVTuber企画」などがあります。
                    <br />
                    <br />
                    この技術はまだまだ新しく、これから世界を変えていく可能性を大いに秘めています。
                    <br />
                    <br />
